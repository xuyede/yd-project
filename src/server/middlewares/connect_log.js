/**
 * https://github.com/dominhhai/koa-log4js/blob/v2.x/koa-logger.js
 */

import log4js from 'log4js';
const levels = log4js.levels;
const DEFAULT_FORMAT = ':remote-addr - -' +
  ' ":method :url :httpParam HTTP/:http-version"' +
...
function assembleTokens(ctx, customTokens) {
  ...
  defaultTokens.push({
    token: ':httpParam',
    replacement: JSON.stringify(ctx.request.body)
  })
